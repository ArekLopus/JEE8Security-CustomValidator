...
//http://localhost:8080/JEE8Security-CustomValidator/res/sec/secured
//http://localhost:8080/JEE8Security-CustomValidator/res/sec/login
//http://localhost:8080/JEE8Security-CustomValidator/res/sec/logout
@Path("sec")
